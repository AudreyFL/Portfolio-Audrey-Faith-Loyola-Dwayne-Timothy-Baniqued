...
# ===========================
df <- read.csv("C:/Users/Audrey Loyola/Dropbox/2_Demographic_Behavioral_data_Group_015.csv", stringsAsFactors = FALSE)
...
# ===================================
write.csv(df_clean, "C:/Users/Audrey Loyola/Dropbox/cleaned_demographic_behavioral_data.csv", row.names = FALSE)