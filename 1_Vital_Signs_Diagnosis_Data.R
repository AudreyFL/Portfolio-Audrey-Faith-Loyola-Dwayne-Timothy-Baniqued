...
df <- read.csv("C:/Users/Audrey Loyola/Dropbox/1_Vital_signs_diagnosis_data_Group_015.csv", stringsAsFactors = FALSE)

# ----------------------
# Clean and Preprocess
# ----------------------

# Convert to numeric where needed (remove symbols just in case)
...
# Save cleaned data 
# --------------------
write.csv(df_clean, "C:/Users/Audrey Loyola/Dropbox/cleaned_Vital_signs_diagnosis_data.csv", row.names = FALSE)
